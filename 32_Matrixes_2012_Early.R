...
### This code does exactly the same this that 12_Matrixes_2012
...
diff_sits = read_csv("Base/diff_mean_sits_medio_tte_origen_destinoEarly5.csv")

# Differences in travel times by communes
mean_diff = read_csv("Base/diff_means_communeEarly5.csv")
...
eod_2017 = read_csv("Base/times_eod_2017_filterEarly5.csv")
...
write.csv(mat, row.names = FALSE, file = "Base/diff_matrix_publicoEarly5.csv")
...
write.csv(times, row.names = FALSE,  file = "Base/travel_times_public_2012Early5.csv", na = "")
...
write.csv(mat, row.names = FALSE,  file = "Base/diff_matrix_privadoEarly5.csv")
rm(datatemp, temp, destino, diff, i, j, origen, pertime)
length(mat[mat<0])
...
write.csv(times, row.names = FALSE, file = "Base/travel_times_private_2012Early5.csv", na = "")

...
### This code does exactly the same this that Time_Differences_SITs 
...
write.csv(temp3, row.names = FALSE, file = "Base/diff_mean_sits_medio_tte_origen_destinoEarly5.csv")

...
write.csv(results, 
          "Base/bootstrap_dependiente_TA_Public_remuestreo_parejas_2025.csv")
...
results_final <- fread("Base/bootstrap_dependiente_TA_Public_remuestreo_parejas_2025.csv")
...
write.csv(results_final, 
          "Base/bootstrap_dependiente_TA_Public_for_tab_remuestreo_parejas_2025.csv")

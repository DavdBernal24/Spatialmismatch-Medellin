...
## this code identifies the socieconomic strata from the SIT zones and add the wage by SIT
## (We ended up keeping it constant)
...
# costs information
costs <- read_csv("Base/Wmin.csv", col_types = cols(X1 = col_skip()))
...
#Average wage
write.csv(costs, file = "Base/costs_wmin.csv")

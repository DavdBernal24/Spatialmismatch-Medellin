...
## RF COMMENT ABOUT DISTANCE, In This function we use the costs from binsreg
### Purpose : This code creates a function for public transport TA
compute_ta_newcost <- function(sits_complete, travel_times, travel_distances, costs, emp,
                       transport_cost, adjustment,ipc,
                       varname, percap_varname, ruta, filename, year) {

...
### This code gets the wages from the "Calidad de vida survey" for Medellin.  
...
salarios2017 = read_csv("Data/ECV_wages/ECV_2017.csv")
...
salarios2012 = read_csv("Data/ECV_wages/ECV_2011.csv")
